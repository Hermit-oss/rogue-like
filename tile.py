...
class TileMap():
 ...
 #                       if self.enemies.enemy_X[checked_enemy] > y*25 and self.enemies.enemy_X[checked_enemy] < (y+1)*25:
 #                           if self.enemies.enemy_Y[checked_enemy] > x*25 and self.enemies.enemy_Y[checked_enemy] < (x+1)*25:
    ...
    def draw(self, screen):
        ...
        for row in self.tile_map:
            for tile in row:
                tile.draw(screen)
        self.enemies.display_enemy(screen)
